...
REALITY_PK=$(openssl rand -base64 32 | tr -d '\n\r')
REALITY_SID=$(openssl rand -base64 8 | tr -d '\n\r')
REALITY_PK_ESCAPED=$(printf '%s' "$REALITY_PK" | sed 's/"/\\"/g')
REALITY_SID_ESCAPED=$(printf '%s' "$REALITY_SID" | sed 's/"/\\"/g')
